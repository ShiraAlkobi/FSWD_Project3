const StudyStorage = {
            ...
            login: (email, password) => {
                const user = StudyStorage.getUsers().find(u => u.email === email && u.password === password);
        ...
        const app = {
            ...
            handleLogin: function(e) {
                e.preventDefault();
                const res = StudyStorage.login(document.getElementById('loginEmail').value, document.getElementById('loginPassword').value);
                if (res.success) {
            ...
            handleRegister: function(e) {
                e.preventDefault();
                const res = StudyStorage.register(document.getElementById('regEmail').value, document.getElementById('regPassword').value, document.getElementById('regName').value);
                if (res.success) {
                    this.currentUser = res.user;
                    localStorage.setItem('study_current_session', JSON.stringify(this.currentUser));
                    this.navigate('dashboard');
            ...
            initDashboard: function() {
                // Populate New Profile Header UI
